function [baseMVA, Bus, Branch, Oltc, Cap, Pv, Gen] = case33
...
%  BUS_OLTC, KMIN, KMAX, MAXTAP_OLTC
Oltc = [1  0.95  1.05  10];
...
Pv = [
      12  0.6  0  1.2  0.2 -0.5 0.5  
      14  0.6  0  1.2  0.2 -0.5 0.5 
      16  0.6  0  1.2  0.2 -0.5 0.5 
      18  0.6  0  1.2  0.2 -0.5 0.5 
      31  0.6  0  1.2  0.2 -0.5 0.5 
      33  0.6  0  1.2  0.2 -0.5 0.5 ];
...
Branch(:, [BR_R BR_X]) = Branch(:, [BR_R BR_X]) / (Vbase^2 / Sbase);
