...
if solve.problem == 0
    ...
    results.tactical_wind = value(vars.tactical_wind);  % 风电上层决策
    results.tactical_pv = value(vars.tactical_pv);      % 光伏上层决策
    results.tactical_ess = value(vars.tactical_ess);    % 储能上层决策
